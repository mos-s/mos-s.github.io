...
(function (ns)
{
  "use strict";
   ...
   ns.GPGPUtility = function (width_, height_, attributes_)
   {
     ...
     this.makeSizedTexture2 = function(width, height, type, data)
     {
       var texture;
       ...
       gl.texImage2D(gl.TEXTURE_2D, // Target, matches bind above.
                     0,             // Level of detail.
                     gl.RED,//gl.RGBA,       // Internal format.
                     width,         // Width - normalized to s.
                     height,        // Height - normalized to t.
                     0,             // Always 0 in OpenGL ES.
                     gl.R32F,//gl.R32F,//gl.RGBA,       // Format for each pixel.
                     gl.INT,//gl.FLOAT,//type,          // Data type for each chanel.
                     data);         // Image data in the described format, or null.
       // Unbind the texture
       gl.bindTexture(gl.TEXTURE_2D, null);
